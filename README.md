...
## Um breve resumo!
Sou um estudante de Análise e Desenvolvimento de Sistemas. Minha paixão por tecnologia e programação me impulsiona a buscar oportunidades para fortalecer minha formação em Análise e Desenvolvimento de Sistemas, com ênfase em análise de dados e desenvolvimento de software. Tenho especial interesse em linguagens de programação Java, Python, SQL e atuar com sistemas de Banco de Dados, tanto relacionais quanto não relacionais.
